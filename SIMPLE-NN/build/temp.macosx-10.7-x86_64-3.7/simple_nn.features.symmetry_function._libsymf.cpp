...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 5), // int()(double * *, double * *, double * *, int *, int, int *, int, int * *, double * *, int, double * *, double * *)
/*  1 */ _CFFI_OP(_CFFI_OP_POINTER, 14), // double * *
...
/* 14 */ _CFFI_OP(_CFFI_OP_POINTER, 15), // double *
/* 15 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 14), // double
};

static int _cffi_d_calculate_sf(double * * x0, double * * x1, double * * x2, int * x3, int x4, int * x5, int x6, int * * x7, double * * x8, int x9, double * * x10, double * * x11)
{
  return calculate_sf(x0, x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_calculate_sf(PyObject *self, PyObject *args)
{
  ...
  if (!PyArg_UnpackTuple(args, "calculate_sf", 12, 12, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6, &arg7, &arg8, &arg9, &arg10, &arg11))
    return NULL;
  ...
  _cffi_restore_errno();
  { result = calculate_sf(x0, x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11); }
  _cffi_save_errno();
